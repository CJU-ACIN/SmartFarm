...
$(document).ready(function() {
    ...
    source.onmessage = function(event) {
        ...
        if (time_temp != data_graph.time){
            time_temp = data_graph.time;
    ...
    source2.onmessage = function(event) {
        ...
        $("#actuator_cm").text(data_other.value1);
        ...
        if(data_other.standlight=="ON"){
            ...
            $("#standlight").text("light => ON");
        }
        else{
            $("img#standlight_img").attr('src',"static/img/light_off.png");
            $("#standlight").text("light => OFF");
        }

        config_actuator.data.datasets[0].data[0] = data_other.value1.split("cm")[0];
